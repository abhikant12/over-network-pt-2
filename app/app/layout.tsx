...
const cal = localFont({
  src: '/cal.woff2', // Make sure the font file is accessible at this path
  display: 'swap',
  variable: '--font-cal',
});
...
const matter = localFont({
  src: [
    {
      path: '/Matter-Regular.woff2', // Make sure the font file is accessible at this path
      weight: '400',
      style: 'normal',
    },
    {
      path: '/Matter-Medium.woff2', // Make sure the font file is accessible at this path
      weight: '400',
      style: 'normal',
    },
    {
      path: '/Matter-Bold.woff2', // Make sure the font file is accessible at this path
      weight: '700',
      style: 'normal',
    },
  ],
...
export default async function RootLayout({
  ...
  const setUpProfile = async (form: FormData) => {
    ...
    try {
      ...
      await login(user.username, user.privateKey);
    } catch (error) {
      dropUser(user);
      throw error;
    }
